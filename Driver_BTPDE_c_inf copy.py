...
from src.samplegrid import samplegrid
...
if __name__ == "__main__":
    ...
    '''Boundary Conditions'''
    Input_BC_train = np.vstack ( ( samplegrid((Coord_xi,Coord_eta,Coord_z,t),args.N_BC_train,0,-radius), 
                                    samplegrid((Coord_xi,Coord_eta,Coord_z,t),args.N_BC_train,0,radius), 
                                    samplegrid((Coord_xi,Coord_eta,Coord_z,t),args.N_BC_train,1,-radius), 
                                    samplegrid((Coord_xi,Coord_eta,Coord_z,t),args.N_BC_train,1,radius) ) )
    ...
    Input_BC_train_circle = torch.from_numpy(Input_BC_train_circle).float().to(device)
